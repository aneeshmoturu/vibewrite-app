...
export default async function DashboardPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#030303] text-zinc-50 font-sans">
      ...
      {/* 1. The Custom High-Performance Interactive Background */}
      <InteractiveWireframe />

      {/* 2. Main Content Wrapper 
          Notice `pointer-events-none` here. This lets mouse movements "pass through" 
          the empty space to the interactive background below! 
      */}
      <div className="relative z-10 p-6 sm:p-12 max-w-7xl mx-auto flex flex-col min-h-screen pointer-events-none">
        
        {/* Header - pointer-events-auto ensures your buttons are still clickable */}
        ...
        {/* The Generator Form - pointer-events-auto so users can click and type */}
